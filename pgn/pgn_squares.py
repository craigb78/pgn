...
# square numbers decrease left to right (A8 to H8) then top to bottom
A8 = 2**63
B8 = 2**62
C8 = 2**61
D8 = 2**60
...
# reverse lookup form "e1" : E1 etc
str_bitmap = {value: key for (key,value) in bitmap_str.items()}


def str_to_square(sq_str: str) -> int:
    return str_bitmap[sq_str]
